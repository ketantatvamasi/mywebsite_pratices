            ...
            <label>
                ...
                <select class="bam-fonts-select" <?php $this->link() ?>>
                    ...
                    <?php
                        // System Fonts. 
                        ?>
                        <optgroup label="<?php esc_attr_e( 'System Font Stack', 'bam-pro' ); ?>">
                            <option value="system-stack" <?php selected( 'system-stack', $this->value() ); ?>><?php echo esc_html__( 'System Font', 'bam-pro' ); ?></option>
                        </optgroup>
